    ...
    return (
        <div className='anime-container'>
            ...
            <div className='anime-body'>
                <p className='text-center font-bold font-mono text-4xl'>Anime</p>
                <p className='text-2xl text-center text-red-500 font-bold'>!This Test Only!</p>
                <div className='anime-search'>
                    <input className='anime-search-input' type="text" name="" id="" placeholder='anime name...' onChange={(e) => { setSearch(e.target.value) }} />
